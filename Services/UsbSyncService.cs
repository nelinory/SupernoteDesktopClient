...
namespace SupernoteDesktopClient.Services
{
    public class UsbSyncService : ISyncService
    {
        ...
        public string BackupFolder { get { return GetFolderByType(FileSystemManager.BACKUP_FOLDER); } }

        public string ArchiveFolder { get { return GetFolderByType(FileSystemManager.ARCHIVE_FOLDER); } }
